...
### 数据库表（45 张，V0.1.42 +Group.announce；V0.1.41 +TrainingPlan+UserPlanEnrollment；V0.1.37 +GroupBuy+GroupBuyMember；V0.1.34 +Family+FamilyMember + Goal.familyId；V0.1.32 +Follow；V0.1.31 +Notification；V0.1.30 +Feed+FeedLike+FeedComment；V0.1.29 +Favorite；V0.1.28 +Goal；V0.1.26 +Shoe + Checkin.shoeId）
...
- ✅ Prisma **45** 张表 + 19 个迁移（V0.1.42 +Group.announce；V0.1.41 +TrainingPlan+UserPlanEnrollment；V0.1.37~38 +GroupBuy+GroupBuyMember + Order.groupBuyId；V0.1.36 Feed +topic+videoUrl；V0.1.34 +Family+FamilyMember + Goal.familyId；V0.1.33 零 schema 改；V0.1.32 +Follow + User following/followers 双 relation；V0.1.31 +Notification + User notifications/notifActions relation；V0.1.30 +Feed+FeedLike+FeedComment；V0.1.29 +Favorite；V0.1.28 +Goal；V0.1.26 +Shoe + Checkin.shoeId；V0.1.25 零新表）
