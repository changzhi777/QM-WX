...
13. ✅ **测试覆盖率阈值**（V0.1.131 GAP-3 全关闭）— V0.1.102 加 thresholds 78/80/75/78；V0.1.112 routes 全测后 84/87/75/84；V0.1.134 实测 **lines 85.44% / functions 86.97% / branches 77.50% / statements 85.44%** > **阈值 84/86/75/84**（funcs 0.97% 缓冲，其余 1.44%+ 缓冲）；**当前 840 单元 / 49 页 / 31 module / 56 表 / 36 迁移**
