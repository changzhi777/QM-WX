...
13. ✅ **测试覆盖率阈值**（V0.1.131 GAP-3 全关闭）— V0.1.102 加 thresholds 78/80/75/78；V0.1.112 routes 全测后 84/87/75/84；V0.1.135 实测 **lines 85.47% / functions 86.74% / branches 77.13% / statements 85.47%** > **阈值 84/86/75/84**（funcs 0.74% 缓冲，其余 1.47%+ 缓冲）；**当前 846 单元 / 49 页 / 31 module / 56 表 / 37 迁移**
