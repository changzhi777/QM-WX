...
13. ✅ **测试覆盖率阈值**（V0.1.131 GAP-3 全关闭）— V0.1.102 加 thresholds 78/80/75/78；V0.1.112 routes 全测后 84/87/75/84；V0.1.131 实测 **lines 85.14% / functions 86.61% / branches 77.84% / statements 85.14%** > **阈值 84/86/75/84**（funcs 0.61% 缓冲，其余 1.14%+ 缓冲）；**当前 816 单元 / 47 页 / 31 module / 55 表 / 35 迁移**
