...
13. ✅ **测试覆盖率阈值**（V0.1.131 GAP-3 全关闭）— V0.1.102 加 thresholds 78/80/75/78；V0.1.112 routes 全测后 84/87/75/84；V0.1.133 实测 **lines 85.28% / functions 86.81% / branches 77.73% / statements 85.28%** > **阈值 84/86/75/84**（funcs 0.81% 缓冲，其余 1.28%+ 缓冲）；**当前 825 单元 / 48 页 / 31 module / 55 表 / 35 迁移**
